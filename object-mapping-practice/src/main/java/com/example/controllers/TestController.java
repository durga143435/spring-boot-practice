...
import com.example.dtos.combined.CombinedResponseDto;
import com.example.dtos.service1.UserAccDetailsDto;
import com.example.dtos.service2.OrderDetailsDto;
import com.example.mappers.CombinedResponseMapper;
import com.example.services.OutboundService;
...
//                    System.out.println(10/0);
        ...
        CompletableFuture<OrderDetailsDto> serviceCall2 = CompletableFuture.supplyAsync(this::handleOrder);
//                ()-> {
//                    try {
//                        Thread.sleep(8000);
//                    } catch (InterruptedException e) {
...
//        );
        ...
        CompletableFuture.allOf(serviceCall1, serviceCall2);
...
//        return ResponseEntity.ok(new CombinedResponseDto());
    ...
    private OrderDetailsDto handleOrder() {
        try {
            Thread.sleep(8000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
